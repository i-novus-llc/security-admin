...
public class UserInfoAdvice {
    ...
    @Pointcut("@annotation(net.n2oapp.framework.security.autoconfigure.userinfo.UserInfo)")
    public void userinfoTranslateMethods() {
    }

    @Pointcut("within(@net.n2oapp.framework.security.autoconfigure.userinfo.UserInfo *) && execution(* *(..))")
