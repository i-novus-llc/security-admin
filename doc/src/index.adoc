...
А также настроить конфигурацию, добавив `BackChannelLogoutFilter`:
...
----
    ...
    protected void configure(HttpSecurity http) throws Exception {
        . . .
        http.addFilterAfter(new BackChannelLogoutFilter(sessionRegistry, "http://localhost:9999/oauth/token_key"), LogoutFilter.class);
    }
----
...
access.keycloak.sync-cron=0 0/17 * * * ? *
----
...
. Создайте права доступа к dашему приложению через liquibase скрипты:
+
[source,sql]
----
