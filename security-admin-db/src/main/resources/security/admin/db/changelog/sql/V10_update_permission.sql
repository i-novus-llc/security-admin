...
COMMENT ON COLUMN ${n2o.security.admin.schema}.${n2o.security.admin.permission.table}.system_code IS 'Прикладная система (подсистема, модуль), которой принадлежит служба';
