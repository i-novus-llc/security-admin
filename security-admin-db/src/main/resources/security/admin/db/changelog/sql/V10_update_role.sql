...
COMMENT ON COLUMN ${n2o.security.admin.schema}.${n2o.security.admin.role.table}.system_code IS 'Прикладная система (подсистема, модуль), которой принадлежит роль';

ALTER TABLE ${n2o.security.admin.schema}.${n2o.security.admin.role.table} ADD COLUMN user_level VARCHAR(50);
COMMENT ON COLUMN ${n2o.security.admin.schema}.${n2o.security.admin.role.table}.user_level IS 'Уровень пользователя, для которого предназначена роль';