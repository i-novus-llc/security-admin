CREATE TABLE IF NOT EXISTS ${n2o.security.admin.schema}.${n2o.security.admin.client.table} (
  ...
  ${n2o.security.admin.client.column.client_id} VARCHAR(255) NOT NULL UNIQUE,
...
COMMENT ON COLUMN ${n2o.security.admin.schema}.${n2o.security.admin.client.table}.id  IS 'ID клиента';
